...
export const NegociosAdmin: React.FC<NegociosAdminProps> = ({ user }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tarjetas de Métricas de Negocios en Estadio (Scoreboard Style) */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        <div className="bg-[#0F1626] p-4 rounded-2xl border border-slate-700/80 shadow-lg relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-red-600 via-amber-500 to-transparent"></div>
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-sports font-bold text-slate-400 uppercase tracking-wider">Locales / Puestos</span>
            <div className="p-1.5 rounded-lg bg-red-950/60 border border-red-500/30 text-red-400">
              <Store className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-2 text-3xl font-scoreboard font-black tracking-tight text-white">{stands.length}</div>
          <p className="text-[11px] font-sports text-slate-400 mt-0.5 uppercase tracking-wide">Espacios en Estadio</p>
        </div>

        <div className="bg-[#0F1626] p-4 rounded-2xl border border-slate-700/80 shadow-lg relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-emerald-500"></div>
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-sports font-bold text-slate-400 uppercase tracking-wider">Abiertos en Vivo</span>
            <div className="p-1.5 rounded-lg bg-emerald-950/60 border border-emerald-500/30 text-emerald-400">
              <CheckCircle2 className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-2 text-3xl font-scoreboard font-black tracking-tight text-emerald-400">{activeStandsCount}</div>
          <p className="text-[11px] font-sports text-slate-400 mt-0.5 uppercase tracking-wide">En operación activa</p>
        </div>

        <div className="bg-[#0F1626] p-4 rounded-2xl border border-slate-700/80 shadow-lg relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-amber-500"></div>
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-sports font-bold text-slate-400 uppercase tracking-wider">Catálogo de Menú</span>
            <div className="p-1.5 rounded-lg bg-amber-950/60 border border-amber-500/30 text-amber-400">
              <Utensils className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-2 text-3xl font-scoreboard font-black tracking-tight text-amber-400">{menuItems.length}</div>
          <p className="text-[11px] font-sports text-slate-400 mt-0.5 uppercase tracking-wide">Platillos y bebidas</p>
        </div>

        <div className="bg-[#0F1626] p-4 rounded-2xl border border-slate-700/80 shadow-lg relative overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-blue-500"></div>
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-sports font-bold text-slate-400 uppercase tracking-wider">Comisión Promedio</span>
            <div className="p-1.5 rounded-lg bg-blue-950/60 border border-blue-500/30 text-blue-400">
              <Percent className="w-4 h-4" />
            </div>
          </div>
          <div className="mt-2 text-3xl font-scoreboard font-black tracking-tight text-white">
            {stands.length > 0
              ? Math.round(
          ...
          <p className="text-[11px] font-sports text-slate-400 mt-0.5 uppercase tracking-wide">Por venta en alimentos</p>
        </div>
      </div>
      ...
      <div className="bg-[#0F1626] p-4 sm:p-5 rounded-2xl border border-slate-700/80 shadow-lg space-y-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm bg-[#0A0E17] border border-slate-700 rounded-xl text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-red-600 focus:border-red-600"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            <button
              onClick={loadData}
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-sports font-bold text-slate-300 bg-[#141C2E] hover:bg-[#1A253C] border border-slate-700/80 rounded-xl transition-all"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-sports font-bold uppercase tracking-wider text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 rounded-xl shadow-md transition-all"
            >
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs scrollbar-none">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg font-sports font-bold uppercase tracking-wider transition-all shrink-0 ${
      ...
      {loading ? (
        ...
        <div className="bg-[#0F1626] rounded-2xl border border-slate-700/80 p-8 text-center text-slate-400 shadow-lg">
          <Store className="w-10 h-10 mx-auto text-slate-600 mb-2" />
          <p className="text-sm font-sports font-bold uppercase tracking-wider text-slate-300">No se encontraron negocios con ese filtro</p>
          <p className="text-xs text-slate-500 mt-1 font-sports">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredStands.map((stand) => {
            ...
            return (
              <div
                key={stand.id}
                className={`bg-[#0F1626] rounded-2xl border transition-all flex flex-col justify-between overflow-hidden shadow-lg hover:border-slate-600 ${
                  stand.active ? 'border-slate-700/80' : 'border-slate-800 bg-[#0F1626]/70 opacity-75'
                }`}
              >
                <div>
                  {/* Foto de Portada con Badge de Estado */}
                  <div className="relative h-40 w-full overflow-hidden bg-[#0A0E17]">
                    <img
                      src={stand.image}
                      alt={stand.name}
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-sports font-bold uppercase tracking-wider bg-[#0A0E17]/90 text-white backdrop-blur-xs border border-white/20">
                    ...
                    <div className="absolute top-3 right-3">
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-sports font-bold uppercase tracking-wider shadow-xs transition-transform active:scale-95 ${
                          stand.active
                    ...
                    <div className="absolute bottom-3 left-3 right-3 text-white">
                      <h3 className="font-sports font-black text-lg tracking-wide leading-snug drop-shadow-xs line-clamp-1">
                        {stand.name}
                      </h3>
                      <div className="flex items-center gap-1 text-xs text-slate-300 mt-0.5 drop-shadow-2xs">
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="space-y-1.5 text-xs text-slate-300 bg-[#0A0E17] p-3 rounded-xl border border-slate-800/80">
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400 font-sports uppercase tracking-wider">Encargado Concesión:</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400 font-sports uppercase tracking-wider">Comisión al Club:</span>
                        <span className="font-scoreboard text-base font-bold text-red-400 bg-red-950/60 px-2 py-0.5 rounded-md border border-red-500/30">
                          {stand.commissionRate !== undefined ? stand.commissionRate : 15}% por venta
                        </span>
                      </div>

                      <div className="flex items-center justify-between">
                        <span className="text-slate-400 font-sports uppercase tracking-wider">Espera Estimada:</span>
                        <span className="font-semibold text-slate-200 flex items-center gap-1">
                          <Clock className="w-3 h-3 text-amber-400" />
                          <span className="font-scoreboard text-base font-bold">{stand.estimatedWaitMinutes || 10}</span> min
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs px-1">
                      <span className="text-slate-400 font-sports uppercase tracking-wider">Platillos en Carta:</span>
                      <span className="font-scoreboard text-base font-bold text-slate-200">
                ...
                <div className="p-3 bg-[#0B101B] border-t border-slate-800/80 flex items-center justify-between gap-2">
                  <button
                    id={`manage-menu-${stand.id}`}
                    onClick={() => openMenuModal(stand)}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#141C2E] hover:bg-[#1A253C] text-slate-200 border border-slate-700/80 rounded-lg text-xs font-sports font-bold uppercase tracking-wider transition-all"
                  >
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="p-1.5 bg-[#141C2E] hover:bg-[#1A253C] text-slate-300 border border-slate-700/80 rounded-lg text-xs transition-all"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 bg-[#141C2E] hover:bg-red-950/60 text-red-400 border border-red-500/30 rounded-lg text-xs transition-all cursor-pointer"
                    >
      ...
      {isStandModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 bg-slate-950/80 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-150">
          <div className="bg-[#0F1626] w-full max-w-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-700 overflow-hidden flex flex-col max-h-[92vh] sm:max-h-[88vh] my-auto animate-in zoom-in-95 duration-150">
            <div className="bg-[#0A0E17] text-white p-4 sm:p-5 flex items-center justify-between border-b border-slate-800 shrink-0">
              <div className="flex items-center gap-2.5">
                <div className="p-2 rounded-xl bg-red-950/60 border border-red-500/30 text-red-400">
                  <Store className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-sports font-black text-base sm:text-lg tracking-wide uppercase">
                    {editingStand ? 'Editar Negocio del Estadio' : 'Registrar Nuevo Negocio / Puesto'}
                  </h3>
                  <p className="text-[11px] sm:text-xs font-sports text-slate-400 uppercase tracking-wider">
            ...
            <form onSubmit={handleSaveStand} className="p-4 sm:p-6 space-y-4 flex-1 overflow-y-auto text-xs sm:text-sm">
              <div>
                <label className="block text-xs font-sports font-bold text-slate-300 uppercase tracking-wider mb-1">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-xs sm:text-sm bg-[#0A0E17] border border-slate-700 rounded-xl text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-red-600 focus:border-red-600 font-semibold"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs sm:text-sm bg-[#0A0E17] border border-slate-700 rounded-xl text-white placeholder:text-slate-500 focus:outline-hidden focus:ring-2 focus:ring-red-600 focus:border-red-600"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 text-xs sm:text-sm bg-[#0A0E17] border border-slate-700 rounded-xl text-white focus:outline-hidden focus:ring-2 focus:ring-red-600 focus:border-red-600 font-medium"
                  >
                    {CATEGORIES.map((cat) => (
                      <option key={cat} value={cat} className="bg-[#0F1626] text-white">
                        {cat}
                      </option>
                    ))}
                  </select>
              ...
              <div className="p-3.5 bg-[#0A0E17] border border-amber-500/30 rounded-xl space-y-2">
                <div className="flex items-center gap-2 text-xs font-sports font-bold text-amber-400 uppercase tracking-wider">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-xs sm:text-sm bg-[#0F1626] border border-slate-700 rounded-lg text-white focus:outline-hidden focus:ring-2 focus:ring-amber-500 font-medium"
                >
                  <option value="" className="bg-[#0F1626] text-slate-400">-- Sin encargado asignado (o Asignar después) --</option>
                  {concesionariosList.map((u) => (
                    <option key={u.uid} value={u.uid} className="bg-[#0F1626] text-white">
                      {u.displayName || u.email} ({u.role ? u.role.toUpperCase() : 'USUARIO'})
                    </option>
                  ))}
                </select>
                <p className="text-[11px] font-sports text-slate-400 uppercase tracking-wide">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-3 pr-7 py-2 text-xs sm:text-sm bg-[#0A0E17] border border-slate-700 rounded-xl text-white font-scoreboard text-base font-bold"
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs sm:text-sm bg-[#0A0E17] border border-slate-700 rounded-xl text-white font-scoreboard text-base font-bold"
                  />
                </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2 overflow-x-auto pb-1">
                  {PRESET_IMAGES.map((preset) => (
                    <button
                      ...
                      className={`px-2.5 py-1 text-[11px] rounded-lg font-sports font-bold uppercase tracking-wider shrink-0 transition-all ${
                        standForm.image === preset.url
                          ? 'bg-gradient-to-r from-red-600 to-red-700 text-white'
                          : 'bg-[#141C2E] text-slate-300 hover:bg-[#1A253C] border border-slate-700/80'
                      }`}
                    >
                      {preset.label}
                    </button>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs bg-[#0A0E17] border border-slate-700 rounded-xl text-slate-300"
                />
              </div>

              {/* Estado Activo */}
              <div className="flex items-center justify-between p-3 bg-[#0A0E17] rounded-xl border border-slate-800">
                <div>
                  <div className="text-xs font-sports font-bold text-white uppercase tracking-wider">Estado de Operación en Estadio</div>
                  <div className="text-[11px] font-sports text-slate-400">
                    {standForm.active
              ...
              <div className="pt-2 flex items-center justify-end gap-3 border-t border-slate-800">
                <button
                  type="button"
                  onClick={() => setIsStandModalOpen(false)}
                  className="px-4 py-2 text-xs font-sports font-bold uppercase tracking-wider text-slate-400 hover:text-white rounded-xl transition-all"
                >
                  Cancelar
                </button>
                <button
                  ...
                  type="submit"
                  disabled={saving}
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-xs font-sports font-bold uppercase tracking-wider rounded-xl shadow-md transition-all disabled:opacity-50"
                >
                  {saving ? (
                    <>
      ...
      {menuModalOpen && selectedStandForMenu && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 bg-slate-950/80 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-150">
          <div className="bg-[#0F1626] w-full max-w-3xl rounded-2xl sm:rounded-3xl shadow-2xl border border-slate-700 overflow-hidden flex flex-col max-h-[92vh] sm:max-h-[88vh] my-auto animate-in zoom-in-95 duration-150">
            <div className="bg-[#0A0E17] text-white p-4 sm:p-5 flex items-center justify-between border-b border-slate-800 shrink-0">
            ...
            <div className="p-4 sm:p-6 space-y-4 flex-1 overflow-y-auto text-xs sm:text-sm">
              <div className="flex items-center justify-between pb-3 border-b border-slate-800">
                <span className="text-xs font-sports font-bold text-slate-300 uppercase tracking-wider">
                  Platillos & Bebidas ({menuItems.filter((m) => m.standId === selectedStandForMenu.id).length})
                </span>
                <button
                  id="add-menu-item-btn"
                  onClick={openNewItemForm}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-xs font-sports font-bold uppercase tracking-wider rounded-lg shadow-sm transition-all"
                >
              ...
              {isItemFormOpen && (
                <form
                  ...
                  className="p-4 bg-[#0A0E17] rounded-2xl border border-slate-800 space-y-3 animate-in fade-in duration-150"
                >
                  <div className="flex items-center justify-between font-sports font-bold text-xs uppercase tracking-wider text-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <label className="block text-[11px] font-sports font-bold text-slate-300 uppercase tracking-wider mb-1">
                        Nombre del Platillo *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-3 py-1.5 text-xs bg-[#0F1626] border border-slate-700 rounded-lg text-white font-semibold"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 text-xs bg-[#0F1626] border border-slate-700 rounded-lg text-white font-scoreboard text-base font-bold"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-2.5 py-1.5 text-xs bg-[#0F1626] border border-slate-700 rounded-lg text-white"
                      >
                        <option value="comida" className="bg-[#0F1626]">Comida</option>
                        <option value="bebida" className="bg-[#0F1626]">Bebida</option>
                        <option value="cerveza" className="bg-[#0F1626]">Cerveza</option>
                        <option value="snack" className="bg-[#0F1626]">Snack</option>
                        <option value="combo" className="bg-[#0F1626]">Combo</option>
                      </select>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-2.5 py-1.5 text-xs bg-[#0F1626] border border-slate-700 rounded-lg text-white font-scoreboard text-base font-bold"
                      />
                    </div>
                    ...
                    <div className="flex items-center gap-2 pt-4">
                      <input
                        ...
                        className="w-4 h-4 accent-red-600 rounded-sm cursor-pointer"
                      />
                      <label htmlFor="item-available-check" className="text-xs font-sports font-bold text-slate-200 uppercase tracking-wider">
                        Disponible en venta
                      </label>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 text-xs bg-[#0F1626] border border-slate-700 rounded-lg text-white placeholder:text-slate-500"
                    />
                  </div>
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <button
                      type="button"
                      onClick={() => setIsItemFormOpen(false)}
                      className="px-3 py-1.5 text-xs font-sports font-bold uppercase tracking-wider text-slate-400 hover:text-white rounded-lg"
                    >
                      Cancelar
                    </button>
                    <button
                      type="submit"
                      disabled={saving}
                      className="px-4 py-1.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-xs font-sports font-bold uppercase tracking-wider rounded-lg shadow-sm"
                    >
                  ...
                  .map((item) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <div className="font-sports font-bold text-white text-base flex items-center gap-2">
                            <span>{item.name}</span>
                            <span
                              className={`px-2 py-0.5 rounded-full text-[10px] font-sports font-bold uppercase tracking-wider ${
                                item.available
                                  ? 'bg-emerald-950/70 border border-emerald-500/30 text-emerald-400'
                                  : 'bg-red-950/70 border border-red-500/30 text-red-400'
                              }`}
                            >
                          ...
                          <div className="text-sm font-scoreboard font-bold text-red-400 mt-0.5">${item.price} MXN</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-auto">
                        <button
                          ...
                          className={`px-2.5 py-1 text-xs font-sports font-bold uppercase tracking-wider rounded-lg transition-all ${
                            item.available
                              ? 'bg-[#141C2E] text-slate-300 hover:bg-[#1A253C] border border-slate-700/80'
                              : 'bg-emerald-950/60 text-emerald-400 border border-emerald-500/30 hover:bg-emerald-900/80'
                          }`}
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 bg-[#141C2E] hover:bg-[#1A253C] text-slate-300 border border-slate-700/80 rounded-lg text-xs"
                        >
                          <Edit2 className="w-3.5 h-3.5" />
                        </button>
                        <button
                          onClick={() => handleRequestDeleteItem(item)}
                          className="p-1.5 bg-[#141C2E] hover:bg-red-950/60 text-red-400 border border-red-500/30 rounded-lg text-xs cursor-pointer"
