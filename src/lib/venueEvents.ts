...
export const DEFAULT_FALLBACK_EVENTS: VenueEvent[] = [
  // OCTUBRE 2026
  {
    id: 'event-guasave-2026-10-16',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Algodoneros de Guasave (Inauguración)',
    opponent: 'Algodoneros de Guasave',
    date: '2026-10-16',
    time: '20:00 hrs',
    ...
    ...computeDefaultOrderingWindow('2026-10-16', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:00.000Z',
  },
  {
    id: 'event-guasave-2026-10-17',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Algodoneros de Guasave (Serie Inaugural)',
    opponent: 'Algodoneros de Guasave',
    date: '2026-10-17',
    time: '19:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-10-17', '19:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:01.000Z',
  },
  {
    id: 'event-guasave-2026-10-18',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Algodoneros de Guasave (Serie Inaugural)',
    opponent: 'Algodoneros de Guasave',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-10-18', '18:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:02.000Z',
  },
  {
    id: 'event-jalisco-2026-10-23',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Charros de Jalisco',
    opponent: 'Charros de Jalisco',
    date: '2026-10-23',
    time: '20:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    active: true,
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-10-23', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:03.000Z',
  },
  {
    id: 'event-jalisco-2026-10-24',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Charros de Jalisco',
    opponent: 'Charros de Jalisco',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-10-24', '19:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:04.000Z',
  },
  {
    id: 'event-jalisco-2026-10-25',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Charros de Jalisco',
    opponent: 'Charros de Jalisco',
  ...
  {
    id: 'event-navojoa-2026-10-30',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Mayos de Navojoa',
    opponent: 'Mayos de Navojoa',
    date: '2026-10-30',
    time: '20:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    active: true,
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-10-30', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:06.000Z',
  },
  {
    id: 'event-navojoa-2026-10-31',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Mayos de Navojoa',
    opponent: 'Mayos de Navojoa',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-10-31', '19:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
  ...
  // NOVIEMBRE 2026
  {
    id: 'event-navojoa-2026-11-01',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Mayos de Navojoa (Cierre de Serie)',
    opponent: 'Mayos de Navojoa',
    date: '2026-11-01',
    time: '18:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-01', '18:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:08.000Z',
  },
  {
    id: 'event-mochis-2026-11-10',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Cañeros de Los Mochis',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-10', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:09.000Z',
  },
  {
    id: 'event-mochis-2026-11-11',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Cañeros de Los Mochis',
    opponent: 'Cañeros de Los Mochis',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-11', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:10.000Z',
  },
  {
    id: 'event-mochis-2026-11-12',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Cañeros de Los Mochis',
    opponent: 'Cañeros de Los Mochis',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-12', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:11.000Z',
  },
  {
    id: 'event-jalisco-2026-11-17',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Charros de Jalisco',
    opponent: 'Charros de Jalisco',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-17', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:12.000Z',
  },
  {
    id: 'event-jalisco-2026-11-18',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Charros de Jalisco',
    opponent: 'Charros de Jalisco',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-18', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:13.000Z',
  },
  {
    id: 'event-jalisco-2026-11-19',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Charros de Jalisco',
    opponent: 'Charros de Jalisco',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-19', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:14.000Z',
  },
  {
    id: 'event-yaquis-2026-11-24',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Yaquis de Ciudad Obregón (Inicio 2da Vuelta)',
    opponent: 'Yaquis de Ciudad Obregón',
    date: '2026-11-24',
    time: '20:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    active: true,
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-24', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:15.000Z',
  },
  {
    id: 'event-yaquis-2026-11-25',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Yaquis de Ciudad Obregón (2da Vuelta)',
    opponent: 'Yaquis de Ciudad Obregón',
    date: '2026-11-25',
    time: '20:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-25', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:16.000Z',
  },
  {
    id: 'event-yaquis-2026-11-26',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Yaquis de Ciudad Obregón (2da Vuelta)',
    opponent: 'Yaquis de Ciudad Obregón',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-11-26', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
  ...
  // DICIEMBRE 2026
  {
    id: 'event-naranjeros-2026-12-01',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-01', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:18.000Z',
  },
  {
    id: 'event-naranjeros-2026-12-02',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Naranjeros de Hermosillo',
    opponent: 'Naranjeros de Hermosillo',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-02', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:19.000Z',
  },
  {
    id: 'event-naranjeros-2026-12-03',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Naranjeros de Hermosillo',
    opponent: 'Naranjeros de Hermosillo',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-03', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:20.000Z',
  },
  {
    id: 'event-tomateros-2026-12-18',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-18', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:21.000Z',
  },
  {
    id: 'event-tomateros-2026-12-19',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Tomateros de Culiacán',
    opponent: 'Tomateros de Culiacán',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-19', '19:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:22.000Z',
  },
  {
    id: 'event-tomateros-2026-12-20',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Tomateros de Culiacán',
    opponent: 'Tomateros de Culiacán',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-20', '18:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:23.000Z',
  },
  {
    id: 'event-guasave-2026-12-25',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Algodoneros de Guasave (Serie Navideña)',
    opponent: 'Algodoneros de Guasave',
    date: '2026-12-25',
    time: '20:00 hrs',
    gate: 'Puertas 1, 2, 4 y 8',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-25', '20:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:24.000Z',
  },
  {
    id: 'event-guasave-2026-12-26',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Algodoneros de Guasave (Serie Navideña)',
    opponent: 'Algodoneros de Guasave',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-26', '19:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
    createdAt: '2026-01-01T00:00:25.000Z',
  },
  {
    id: 'event-guasave-2026-12-27',
    venueId: DEFAULT_VENUE_ID,
    type: 'baseball',
    name: 'Venados de Mazatlán vs Algodoneros de Guasave (Serie Navideña)',
    opponent: 'Algodoneros de Guasave',
    ...
    ticketsAvailable: true,
    posterUrl: getEventPosterPlaceholder('baseball'),
    ...computeDefaultOrderingWindow('2026-12-27', '18:00 hrs'),
    priceTiers: MARISCAL_PRICE_TIERS,
